...
import { ArrowLeft, Play, RefreshCw, Download, Loader2, FileText, Heart, Tag, AlertCircle, Sparkles, Check } from 'lucide-react'
                    ...
                    <CardContent>
                        <div className="space-y-3">
                            {survey.questions.map((question, idx) => (
                                <div key={question.question_id} className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-md border border-gray-200 dark:border-gray-700">
